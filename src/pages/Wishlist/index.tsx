    ...
    <>
      ...
      <section className="detail-page-link">
        ...
        <div className="wishlist-title">
            ...
            <p>Lưu lại những sản phẩm bạn yêu thích để dễ dàng tìm lại và mua sắm khi bạn sẵn sàng,<br />
                giúp việc mua sắm trở nên tiện lợi và nhanh chóng hơn bao giờ hết.</p>
        </div>
