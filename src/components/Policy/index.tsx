      ...
      <section className="Policy-full">
        ...
        <div className="box-policy">
            ...
            <div className="box-policy-2">
                ...
                <p>Giao hàng nhanh chóng, an toàn đến tận nhà bạn với dịch vụ vận chuyển chuyên nghiệp.</p>
            </div>
            <div className="box-policy-2">
                <img src="/images/products/support.svg" alt="" />
                <div className="policy-text">Hỗ trợ 24/7</div>
                <p>Đội ngũ tư vấn luôn sẵn sàng giải đáp mọi thắc mắc của bạn mọi lúc, mọi nơi.</p>
            </div>
            <div className="box-policy-2">
