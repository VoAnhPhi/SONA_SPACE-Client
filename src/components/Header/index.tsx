                        ...
                        <div className="sub-menu-wrapper">
                          <div className="sub-menu-column">
                            <ul>
                              ...
                              <li><a href="/san-pham/tab-dau-giuong">Tab đầu giường</a></li>
                              <li><a href="/san-pham/tu-trang-tri">Tủ trang trí</a></li>
                              <li><a href="/san-pham/tham">Thảm</a></li>
                              <li><a href="/san-pham/ghe-don">Ghế đơn</a></li>
                              <li><a href="/san-pham/den-ban-an">Đèn bàn ăn</a></li>
                              <li><a href="/san-pham/ghe-van-phong">Ghế văn phòng</a></li>
                              <li><a href="/san-pham/den-trang-tri">Đèn trang trí</a></li>
                              <li><a href="/san-pham/ke-sach">Kệ sách</a></li>
                            </ul>
                          </div>
                            ...
                            <div className="product-row">
                              <div className="product-item">
                                <a href="/san-pham/tu-trang-tri">
                                  <div className="product-image"></div>
                                  <div className="product-title">Tủ trang trí</div>
                                </a>
                              </div>
                              <div className="product-item">
                                <a href="/san-pham/den-phong-khach">
                                  <div className="product-image"></div>
                                  <div className="product-title">Đèn phòng khách</div>
                                </a>
                              </div>
                              <div className="product-item">
                              ...
                              <div className="product-item">
                                <a href="/san-pham/ban-trang-diem">
                                  <div className="product-image"></div>
                                  <div className="product-title">Bàn trang điểm</div>
                                </a>
                              </div>
                            </div>
                          </div>
