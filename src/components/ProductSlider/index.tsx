...
export default function ProductSlider() {
    ...
    useEffect(() => {
        const handleMouseMove = (e: MouseEvent) => {
            ...
            sliderRef.current.scrollLeft = Math.max(0, Math.min(maxScroll, newScrollLeft));
            setStartX(e.clientX);
    ...
    return (
        <div className="product-slider-container">
            {showLeftArrow && (
                <button className="slider-arrow slider-arrow-left" onClick={handleScrollLeft}>
            ...
            {showRightArrow && (
                <button className="slider-arrow slider-arrow-right" onClick={handleScrollRight}>
