                      ...
                      {orders.map((order) => (
                        <div className="order-item" key={order.id}>
                          ...
                          <div className="order-actions">
                            <Link to={`/chi-tiet-don-hang/${order.id}`} className="btn-primary">Xem chi tiết</Link>
                    ...
                    {userInfo.addresses.map((address, index) => (
                      <div className="address-item" key={index}>
                        <div className="address-content">
                          <h4>{index === 0 ? "Địa chỉ mặc định" : `Địa chỉ ${index + 1}`}</h4>
                          <p>{address}</p>
                        </div>
                ...
                <div className="content-section promo-section">
                  ...
                  <div className="promo-codes-grid">
                    {promoCodes.map((promo, index) => (
                      <div className={`promo-code-card ${promo.used ? 'used' : ''}`} key={index}>
                        ...
                        <div className="promo-content">
                          <div className="promo-header">
                            <h4>{promo.code}</h4>
                            {promo.used && <span className="used-badge">Đã sử dụng</span>}
                          </div>
